...
var _appErrorBoundary = _interopRequireDefault(require("../universal/components/app-error-boundary"));
...
describe('main', function () {
  test('OuterApp renders without error', () => {
    ...
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_main.OuterApp, props));
  ...
  test('OuterApp triggers the error page when there is an error', () => {
    ...
    const wrapper = (0, _enzyme.mount)( /*#__PURE__*/_react.default.createElement(_main.OuterApp, props));
    expect(wrapper.find(_appErrorBoundary.default).length).toBe(1);
