...
var _ssrConfig = require("pwa-kit-runtime/utils/ssr-config");
...
const render = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(function* (req, res, next) {
    ...
    const deviceType = (0, _ssrServer.detectDeviceType)(req);
    const props = {
      error: null,
      appState: {},
      routerContext: {},
...
OuterApp.propTypes = {
  ...
  deviceType: _propTypes.default.string
};
...
const serverRenderer = ({
  clientStats,
  serverStats
}) => (req, res, next) => render(req, res, next);
