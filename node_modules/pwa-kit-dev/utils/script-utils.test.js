...
describe('scriptUtils', () => {
  ...
  beforeEach( /*#__PURE__*/_asyncToGenerator(function* () {
    ...
    tmpDir = yield (0, _promises.mkdtemp)(_path.default.join(_os.default.tmpdir(), 'scriptUtils-tests'));
  }));
  afterEach( /*#__PURE__*/_asyncToGenerator(function* () {
    process.env = originalEnv;
    tmpDir && (yield (0, _promises.rm)(tmpDir, {
      recursive: true
    }));
  }));
  ...
  describe('readCredentials', () => {
    test('should work', /*#__PURE__*/_asyncToGenerator(function* () {
      ...
      yield (0, _promises.writeFile)(thePath, JSON.stringify(creds), 'utf8');
