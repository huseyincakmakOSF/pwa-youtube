...
const projectWebpackPath = _path.default.resolve(projectDir, 'webpack.config.js');
  ...
  serveStaticFile(filePath, opts = {}) {
    return (req, res) => {
      req.app.__devMiddleware.waitUntilValid(() => {
        ...
        stat => stat.compilation.name === _configNames.SERVER).compilation;
        const {
          assetsInfo
        } = serverCompilation;
        ...
        const sourceFilePath = _path.default.resolve(sourceFilename);
        res.sendFile(sourceFilePath, _objectSpread({
          headers: {
