...
describe('generateCacheKey', () => {
  ...
  test('user agent affects key', () => {
    ...
    expect((0, _express.generateCacheKey)(request2)).toEqual(`/test/${(0, _ssrServer.getHashForString)(['a=1', 'device=PHONE'].join('-'))}`);
  });
  ...
  test('multiple CloudFront device headers affect key', () => {
    ...
    expect((0, _express.generateCacheKey)(request1)).toEqual(`/test/${(0, _ssrServer.getHashForString)(['a=1', 'device=TABLET'].join('-'))}`);
  });
