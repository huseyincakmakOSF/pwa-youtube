...
const X_PROXY_REQUEST_URL = 'x-proxy-request-url';
exports.X_PROXY_REQUEST_URL = X_PROXY_REQUEST_URL;
const X_MOBIFY_REQUEST_CLASS = 'x-mobify-request-class';
exports.X_MOBIFY_REQUEST_CLASS = X_MOBIFY_REQUEST_CLASS;
const MAX_URL_LENGTH_BYTES = 8192;
 ...
 */
exports.MAX_URL_LENGTH_BYTES = MAX_URL_LENGTH_BYTES;
class Headers {
  /*
...
const X_HEADERS_TO_REMOVE = ['x-api-key', 'x-mobify-access-key', 'x-apigateway-event', 'x-apigateway-context'];
 ...
 * @type {Object}
 */
exports.X_HEADERS_TO_REMOVE = X_HEADERS_TO_REMOVE;
const X_HEADERS_TO_ADD = {
  'x-mobify': 'true'
};
 ...
 * @private
 */
exports.X_HEADERS_TO_ADD = X_HEADERS_TO_ADD;
const ALLOWED_CACHING_PROXY_REQUEST_HEADERS = {
 ...
 */
exports.ALLOWED_CACHING_PROXY_REQUEST_HEADERS = ALLOWED_CACHING_PROXY_REQUEST_HEADERS;
